...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    public  void EndLoadMoreLogic() {
        isLoadMoreing = true;
//        mMaterialFooterView.setVisibility(View.GONE);
        
//        View loadMoreView = LayoutInflater
//                .from(getContext()).inflate(R.layout.view_load_more, this, false);
        
        mMaterialFooterView.removeAllViews();
        TextView tv = new TextView(getContext());
        tv.setText("dao onsod ");
        MaterialFooterView footerView = new MaterialFooterView(getContext());
        LayoutParams layoutParams2 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Util.dip2px(getContext(), hIGHER_HEAD_HEIGHT));
        layoutParams2.gravity = Gravity.BOTTOM;
